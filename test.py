...
# for file in os.listdir('protein_data/modify'):
#     try:
#         f = open(os.path.join('protein_data/modify',file), 'r')
#         print(file)
#         pdb = f.readlines()
#         f.close()
#
...
#
#         g = open(os.path.join('protein_data/modify', file), "w")
#         g.writelines(pdb)
#         g.close()
#     except:
#         pass
...
init()
#
pdb = pose_from_pdb(os.path.join('protein_data/shortest', '1edp.pdb'))
pdb_2 = pose_from_pdb(os.path.join('protein_data/shortest', '1edp.pdb'))
